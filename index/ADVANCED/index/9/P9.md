...
<h4>Video LINK</h4>
<a href="https://www.youtube.com/watch?v=L3Hwd6jNgWs" target="_blank"><img src="https://github.com/net2devcrypto/misc/blob/main/ytlogo2.png" width="120" height="30"></a>
...
```
- You should obtain something similar in return:
```shell
{ last_price: '63000', timestamp: '1728842660' }
```
